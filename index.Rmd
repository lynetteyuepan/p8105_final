---
title: "Exploration of North American Box-office Indicating Factors (2006-2016)"
---
...
text = as.character(readLines("movies_names.txt"))
...
```
**Word Cloud for Movie Names from 2006 to 2016**<img src="Image/word_cloud_movie_names.png">
...
* Data Source:
    ...
    + [The Academy Awards](https://www.kaggle.com/theacademy/academy-awards)
  
  
* Scapring process & cleaning:
    + Firstly, we use the 06-16 movie dataset from kaggle and scrape the box office data from a [online recourse]((http://www.boxofficemojo.com/yearly/chart/?yr=2014&view=releasedate&view2=domestic&sort=gross&order=DESC&&p=.htm)).
