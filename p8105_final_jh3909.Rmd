...
lm(review_score ~ genre, data = movie_with_review_narm) %>% 
  summary()
...
# check if genre is a significant predictor
anova(lm(review_score ~ director, data = movie_total_gross_with_review_narm))
## significant
...
# check if genre is a significant predictor
anova(lm(review_score ~ main_actors, data = total_gross_actor_sep))
## not significant
