...
anova(lm(total_gross_millions ~ genre, data = movie_boxoffice_genre)) %>% 
  knitr::kable(caption = "ANOVA table for total gross as outcome and genre as predictor")
...
## Relationship between total gross and studio
...
movie_total_gross_studio %>% 
  ...
  layout(xaxis = list(title="studio"), yaxis = list(title="total gross in millions"))
```
