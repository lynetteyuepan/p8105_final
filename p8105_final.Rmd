...
movie_boxoffice_genre %>% 
  ...
  layout(xaxis = list(title=" "), yaxis = list(title="total gross in millions"), title = "Boxplot showing the total gross of movies associated with each genre")
...
movie_with_boxoffice %>% 
  ...
  layout(xaxis = list(title=" "), yaxis = list(title="total gross in millions"), title = "Boxplot showing the total gross of movies associated with each director", showlegend = FALSE)
...
total_gross_actor_sep %>% 
  plot_ly(y = ~main_actors,  x = ~total_gross_millions, color = ~main_actors, type = "box") %>% 
  layout(yaxis = list(title=" "), xaxis = list(title="total gross in millions"), title = "Boxplot showing the total gross of movies associated with each actors/actresses", showlegend = FALSE)

```

**Comment:** Then we can visualize the total gross for each actor/actress using boxplot and see if any actors/actresses are associated with significant higher box office. Interestingly, I found that although some actors/actresses are not only associated with significant higher box office but also low box office. The bands of box plot for majority actors/actresses are large, which indicates there is no any actor/actress that can directly associate with the box office of a movie by himself/herself.
...
movie_total_gross_studio %>% 
  ...
  layout(xaxis = list(title="Production company"), yaxis = list(title="total gross in millions"), title = "Boxplot showing the total gross of movies associated with each production company")
```
