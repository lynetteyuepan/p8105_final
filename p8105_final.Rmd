...
movie_total_gross_with_review_narm %>% 
  ...
  layout(xaxis = "Genre", yaxis = "Total gross in millions")
```
...
movie_total_gross_with_review_narm %>% 
  ...
  layout(showlegend = FALSE,xaxis = "Director names", yaxis = "Total gross in millions")
...
total_gross_actor_sep %>% 
  ...
  layout(showlegend = FALSE,xaxis = "Actor names", yaxis = "Total gross in millions")
```
