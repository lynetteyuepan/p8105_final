...
movie_boxoffice_genre %>% 
  ...
  layout(xaxis = list(title=" "), yaxis = list(title="total gross in millions"))
...
movie_with_boxoffice %>% 
  ...
  layout(xaxis = list(title=" "), yaxis = list(title="total gross in millions"), showlegend = FALSE)
...
total_gross_actor_sep %>% 
  ...
  layout(yaxis = list(title=" "), xaxis = list(title="total gross in millions"), showlegend = FALSE)
